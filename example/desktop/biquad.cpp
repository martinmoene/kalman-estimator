...
auto print( int Nsamp, char const * const text, char const * const design, BiQuad && bq )
{
    std::cout <<
        "\n" << text << " " << design << ":\n" << bq <<
    ...
    const auto rng = range( 0.0, 0.5, Nsamp );
...
int main()
{
    print( Nsamp, "Bi-quad filter design", "[b,a] = cheby1(2,3,0.4)" , BiQuad{ { 0.14361 , 0.28721 , 0.14361  }, { -0.67993, 0.49133 } } );
    print( Nsamp, "Bi-quad filter design", "[b,a] = cheby2(2,10,0.4)", BiQuad{ { 0.323496, 0.017539, 0.323496 }, { -0.66299, 0.32752 } } );
}
